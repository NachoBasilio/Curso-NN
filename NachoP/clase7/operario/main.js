...
const agregarOperarioFicha = (trabajadoresArray)=>{
...
const arrayTrabajadores = JSON.parse(localStorage.getItem("trabajadores")) || trabajadores


agregarOperarioFicha(arrayTrabajadores);
